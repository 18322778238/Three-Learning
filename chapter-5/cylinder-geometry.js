...
bootstrapGeometryScene({
  ...
  provideGui: (gui, mesh) => {
    ...
    folder.add(props, 'radiusTop', -10, 10, 0.01).onChange(() => updateMesh(mesh, updateGeometry(props)))
    folder.add(props, 'radiusBottom', -10, 10, 0.01).onChange(() => updateMesh(mesh, updateGeometry(props)))
